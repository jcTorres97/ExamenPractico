            ...
            function() {
                ...
                return {
                    errorLoading: function() {
                        return "Los resultados no se pudieron ser cargados.";
                    },
                    inputTooLong: function(args) {
                        var overChars = args.input.length - args.maximum;

                        var message = "Por favor elimine " + overChars + " carácteres";
                    ...
                    maximumSelected: function(args) {
                        var message = "Solo puede seleccionar un máximo de " + args.maximum + ".";
